...
pub fn test_dwt_driver_db2_single_level_1d_along() {
    ...
    x.chunks_exact(shape[1])
        ...
        .for_each(|(x, sd)| {
            ...
            wavelets::dwt::daubechies::Daubechies2::forward(x, s, d, &bc);
        });
...
pub fn test_dwt_driver_db2_single_2d() {
    ...
    wavelets::tests::test_approx_equal(&x_w, &x_w2, 1E-12, 1E-10);
}
...
pub fn test_dwt_driver_db2_multi_level_1d() {
    ...
    x.chunks_exact(shape[1])
        ...
        .for_each(|(x, sd)| {
            ...
            wavelets::dwt::daubechies::Daubechies2::forward(x, &mut s0, d0, &bc);

            let (s, d1) = s.split_at_mut(n_sd_2 * 2);
            debug_assert_eq!(d1.len(), n_sd_1);
            let mut s1 = vec![0.0; n_sd_1];
            wavelets::dwt::daubechies::Daubechies2::forward(&s0, &mut s1, d1, &bc);

            let (s2, d2) = s.split_at_mut(n_sd_2);
            debug_assert_eq!(d2.len(), n_sd_2);
            wavelets::dwt::daubechies::Daubechies2::forward(&s1, s2, d2, &bc);
        });
...
pub fn test_dwt_driver_db2_multi_level_2d() {
    ...
    wavelets::tests::test_approx_equal(&sd, &sd2, 1E-10, 1E-9);
}
...
pub fn test_dwt_driver_inv_db2_multi_level_2d() {
    ...
    wavelets::tests::test_approx_equal(&x2, &x, 1E-13, 0.0);
}
...
pub fn test_dwt_driver_db2_per_single_level_1d_along() {
    ...
    sd_per
        ...
        .for_each(|(sd_per, sd_bc)| {
            ...
            wavelets::tests::test_approx_equal(&s[1..nd - 1], &s2[2..nd], 1E-15, 0.0);
            wavelets::tests::test_approx_equal(&d[1..nd - 1], &d2[2..nd], 1E-15, 0.0);
        })
}
...
pub fn test_dwt_driver_db2_per_single_level_1d_across() {
    ...
    sd_per
        ...
        .for_each(|(sd_per, sd_bc)| {
            ...
            wavelets::tests::test_approx_equal(&s[..ns], &s2[1..ns + 1], 1E-15, 0.0);
            wavelets::tests::test_approx_equal(&d[..ns], &d2[1..ns + 1], 1E-15, 0.0);
        })
}
...
pub fn test_dwt_driver_db2_per_multi_level_1d() {
    ...
    x.chunks_exact(n_ax)
        ...
        .for_each(|(x, sd)| {
            ...
            assert_eq!(s.len(), ns);
            assert_eq!(d.len(), nd);
            wavelets::dwt::daubechies::Daubechies2::forward_per(x, s, d);
    ...
    wavelets::tests::test_approx_equal(&sd, &sd2, 1E-12, 2E-10);
}
...
pub fn test_dwt_driver_db2_per_multi_level_2d() {
    ...
    wavelets::tests::test_approx_equal(&sd, &sd2, 1E-12, 1E-9);
}
